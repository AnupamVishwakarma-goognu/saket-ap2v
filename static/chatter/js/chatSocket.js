...
chatSocket.onclose=function() {
	console.log('WebSocket disconnected11.');
...
$('#send-button').click( function() {
	...
	if ($.trim($("#send-message").val())) {
      ...
      'message_type': 'text',
		...
		html = '<div class="message" style="margin-top: 15px;"><div class="message-sent-container"><div class="message message-sent"><div class="d-flex align-items-center mb-1"><span style="color: #708485;">'+test+'</span></div><p class="mb-0" style="white-space: pre;">'+message+'</p></div></div></div>'
		$("#chat-dialog").prepend(html)
	}
});
