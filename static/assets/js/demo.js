...
demo = {
    ...
    showEnquiryNotification: function(from, align) {
        color = Math.floor((Math.random() * 4) + 1);

        $.notify({
            icon: "nc-icon nc-app icon-bold",
            message: "Successfully Create Enquiry."
        }, {
            type: type[color],
            timer: 8000,
            placement: {
    ...
    showInstuctorFromCreated: function(from, align) {
        color = Math.floor((Math.random() * 4) + 1);
    ...
    showSwal: function(type) {
        if (type == 'basic') {
            ...
            swal("Error to update!", "Error to update enquiry please try again", 'error')

        } else if (type == 'success-message') {
            swal("Good job!", "You clicked the button!", "success")

        } else if (type == 'enquiry-success') {
            swal("Good job!", "Your Enquiry has been successfully added", "success")

        } else if (type == "enquiry-error") {
            swal("Bad job!", "Your Enquiry has not been added", "error")

        } else if (type == "CourseAdd") {
            swal("Good job!", "Course Successfully Added", "success")

        } else if (type == "enroll-success") {
            swal("Good job!", "Your Enrollment has been successfully added", "success")

        } else if (type == "enroll-error") {
            swal("Bad job!", "Your Enrollment has not been added!", "error")
