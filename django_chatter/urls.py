...
urlpatterns = [
	...
	path('chat/student/<str:uuid>/', views.CreateStudentInstructorChatRoomView.as_view(), name = "chatroom_student"),
	...
	path('loadchatpanal', views.loadchatpanal, name="loadchatpanal")
]
