...
chatSocket.onclose=function() {
	console.log('WebSocket disconnected12.');
...
$('#send-button').click( function() {
	if ($.trim($("#send-message").val())) {
      ...
      'message_type': 'text',
		...
		html = '<div class="message" style="margin-top: 15px;"><div class="message-sent-container"><div class="message message-sent"><div class="d-flex align-items-center mb-1"><span style="color: #708485;">Nov. 23, 2021, 12:37 p.m.</span></div><p class="mb-0">'+message+'</p></div></div></div>'
