  ...
  <body>
   <div class="container">
	<div class="row text-center" style="margin-top: 80px; margin-bottom: 30px;">
		<img align="center" src="AP2V_Logo.png"/>
	</div>
        	...
        	<div class="panel panel-default">
        		<div class="panel-heading">
					...
					<?php else: ?>
						...
						<input type="hidden" name="redirect_url" id="redirect_url" value="https://www.ap2v.com/payonline/">
						<input type="hidden" name="cancel_url" id="cancel_url" value="https://www.ap2v.com/payonline/">
